...
namespace margelo::nitro::nitrocalendar {
  ...
  /**
   * An abstract base class for `NitroCalendar`
   * Inherit this class to create instances of `HybridNitroCalendarSpec` in C++.
   * You must explicitly call `HybridObject`'s constructor yourself, because it is virtual.
   * @example
   * ```cpp
   * class HybridNitroCalendar: public HybridNitroCalendarSpec {
   * public:
   *   HybridNitroCalendar(...): HybridObject(TAG) { ... }
   *   // ...
   * };
   * ```
   */
  class HybridNitroCalendarSpec: public virtual HybridObject {
    public:
      // Constructor
      explicit HybridNitroCalendarSpec(): HybridObject(TAG) { }

      // Destructor
      ~HybridNitroCalendarSpec() override = default;
    ...
    protected:
      // Tag for logging
      static constexpr auto TAG = "NitroCalendar";
  };
