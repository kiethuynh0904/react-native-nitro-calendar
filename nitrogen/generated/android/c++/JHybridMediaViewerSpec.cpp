...
namespace margelo::nitro::mediaviewer {
  ...
  jni::local_ref<JHybridMediaViewerSpec::jhybriddata> JHybridMediaViewerSpec::initHybrid(jni::alias_ref<jhybridobject> jThis) {
    return makeCxxInstance(jThis);
  }

  void JHybridMediaViewerSpec::registerNatives() {
    registerHybrid({
      makeNativeMethod("initHybrid", JHybridMediaViewerSpec::initHybrid),
    });
  }

  size_t JHybridMediaViewerSpec::getExternalMemorySize() noexcept {
    static const auto method = javaClassStatic()->getMethod<jlong()>("getMemorySize");
    return method(_javaPart);
  }

  // Properties
  bool JHybridMediaViewerSpec::getIsBlue() {
    static const auto method = javaClassStatic()->getMethod<jboolean()>("isBlue");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  void JHybridMediaViewerSpec::setIsBlue(bool isBlue) {
    static const auto method = javaClassStatic()->getMethod<void(jboolean /* isBlue */)>("setBlue");
    method(_javaPart, isBlue);
  }
  bool JHybridMediaViewerSpec::getHasBeenCalled() {
    static const auto method = javaClassStatic()->getMethod<jboolean()>("getHasBeenCalled");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  void JHybridMediaViewerSpec::setHasBeenCalled(bool hasBeenCalled) {
  ...
  ColorScheme JHybridMediaViewerSpec::getColorScheme() {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JColorScheme>()>("getColorScheme");
    auto __result = method(_javaPart);
    return __result->toCpp();
  }
  void JHybridMediaViewerSpec::setColorScheme(ColorScheme colorScheme) {
  ...
  std::function<void()> JHybridMediaViewerSpec::getSomeCallback() {
  ...
  void JHybridMediaViewerSpec::setSomeCallback(const std::function<void()>& someCallback) {
  ...
  // Methods
  void JHybridMediaViewerSpec::someMethod() {
